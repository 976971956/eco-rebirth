...
V1.50 启动逐种外部写实替换；当前雪兔、赤狐、林鹿、青环蛇、棕熊、獠牙野猪、林地浣熊、针背豪猪、沼泽鳄、湿地水豚、灵巧水獭、荒原猞猁和岩岭山羊已完成经审计的 CC0/CC-BY 来源记录、物种化 UV/PBR、项目骨架契约与八态烘焙动作。山羊使用紧凑躯干、后掠分段弯角、渐细胡须、分趾蹄和收腿起跳的崖跃角击；`./tools/build_realistic_vertical_slice.sh` 会先重建这十三种和灰狼，再重建尚未替换的回退物种。当前 30 种 Mobile 总顶点为 138,626 / 140,000，候选运行 `./tools/build_release_candidate.sh /tmp/eco-rebirth-v150-rc`。
