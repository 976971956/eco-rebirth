...
V1.50 启动逐种外部写实替换；当前雪兔、赤狐、林鹿、青环蛇、棕熊、獠牙野猪、林地浣熊、针背豪猪、沼泽鳄、湿地水豚、灵巧水獭、荒原猞猁、岩岭山羊、高山狼獾和草原野牛已完成经审计的 CC0/CC-BY 来源记录、物种化 UV/PBR、项目骨架契约与八态烘焙动作。野牛使用前重肩峰、低位宽头、短弯角、胸须、紧凑分趾蹄和低头抬角冲撞；`./tools/build_realistic_vertical_slice.sh` 会先重建这十五种和灰狼，再重建尚未替换的回退物种。当前 30 种 Mobile 总顶点为 138,429 / 140,000，候选运行 `./tools/build_release_candidate.sh /tmp/eco-rebirth-v150-rc`。
