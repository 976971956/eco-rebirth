...
当前仓库已包含一个可以直接运行的完整生态对战原型：四区域程序化低多边形地图、6 种随机玩家物种、10–100 个生态个体、AI 捕食/逃亡/预测绕障、耐力与饱腹、六种野外食物、尸体进食、击杀与生态助攻经验、八级局内成长、精确生命数值、差异化生态技能、死亡轮回、威胁成长、胜负结算，以及键鼠和触屏操作。
...
| 首发内容目标 | 30–40 种；MVP 先做 6 种 | “300 种”作为长期扩展目标 |
