...
V1.50 启动逐种外部写实替换；当前雪兔、赤狐、林鹿、青环蛇、棕熊、獠牙野猪、林地浣熊、针背豪猪、沼泽鳄、湿地水豚、灵巧水獭和荒原猞猁已完成经审计的 CC0/CC-BY 来源记录、物种化 UV/PBR、项目骨架契约与八态烘焙动作。猞猁使用高臀猫科体轴、分层颊毛、耳簇、短黑尾、雪鞋掌和分段蓄力的无声飞扑；`./tools/build_realistic_vertical_slice.sh` 会先重建这十二种和灰狼，再重建尚未替换的回退物种。当前 30 种 Mobile 总顶点为 137,838 / 140,000，候选运行 `./tools/build_release_candidate.sh /tmp/eco-rebirth-v150-rc`。
