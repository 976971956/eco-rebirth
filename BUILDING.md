...
V1.27 为沼泽鳄增加十二骨长躯干结构：主躯干由身体、头颈和三段尾链连续加权，颌骨、四足、背甲与面部细节使用刚性附件。真实浅水会把移动姿势从陆地爬行切换为收足游动，普通攻击驱动张口，死亡翻滚驱动躯干侧卷和尾链甩动；吻部与尾端挂点分别生成咬合和尾流。Hero/Mobile 共用同一规则，碰撞、战斗数值、AI 和存档没有改变。
