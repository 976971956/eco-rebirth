...
V1.50 启动逐种外部写实替换；当前雪兔、赤狐、林鹿、青环蛇、棕熊、獠牙野猪、林地浣熊、针背豪猪、沼泽鳄和湿地水豚已完成经审计的 CC0/CC-BY 来源记录、物种化 UV/PBR、项目骨架契约与八态烘焙动作。水豚使用桶形后躯、钝方高位头骨、短掌行腿、前四后三趾半蹼足和非攻击式同栖安抚；`./tools/build_realistic_vertical_slice.sh` 会先重建这十种和灰狼，再重建尚未替换的回退物种。当前 30 种 Mobile 总顶点为 136,022 / 140,000，候选运行 `./tools/build_release_candidate.sh /tmp/eco-rebirth-v150-rc`。
