...
V1.45 保持相同面数与骨数，只局部增强灰狼肩胸、颈部与后躯的成年体态，并用骨骼休止矩阵转换四肢横向关节轴，修复小跑时绕腿长轴拧转的问题。当前候选运行 `./tools/build_release_candidate.sh /tmp/eco-rebirth-v145-rc`。
