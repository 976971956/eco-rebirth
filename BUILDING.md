...
V1.28 为雪兔增加十二骨连续体轴：主躯干由 Spine、Chest、Neck、Head 平滑加权，四足、双耳、绒尾与面部细节保留刚性附件。真实移动、进食、普通攻击、月影折跃、受击和死亡分别驱动跳跃、低头咀嚼、压身蹬地、缓冲与侧卧姿势；嘴部和胸部技能挂点随骨架移动。Hero/Mobile 共用同一规则，碰撞、技能数值、生态习性、AI 和存档没有改变。
