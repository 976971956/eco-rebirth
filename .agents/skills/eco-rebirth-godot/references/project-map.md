...
- Keep settings limited to audio, graphics, tutorial reset, and campaign reset. Free mode and the easy/adventure/hard run-difficulty selector belong on the home page. Lock difficulty when a world starts; preserve it as a player preference when campaign progress resets.
