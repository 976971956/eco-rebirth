...
"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_lynx.py" -- \
...
"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_wolverine.py" -- \
	--source-dir "$PROJECT_ROOT/assets/source/animals/wolverine/cc_by_all_of_life" \
	--output-root "$PROJECT_ROOT/assets/models_v2/animals"

"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_bison.py" -- \
	--source-dir "$PROJECT_ROOT/assets/source/animals/bison/cc_by_google_poly" \
	--output-root "$PROJECT_ROOT/assets/models_v2/animals"

"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_zebra.py" -- \
...
"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_tiger.py" -- \
	--source-dir "$PROJECT_ROOT/assets/source/animals/tiger/cc_by_google_poly" \
	--output-root "$PROJECT_ROOT/assets/models_v2/animals"

"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_monkey.py" -- \
	--source-dir "$PROJECT_ROOT/assets/source/animals/monkey/cc_by_google_poly" \
	--output-root "$PROJECT_ROOT/assets/models_v2/animals"

"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_owl.py" -- \
	--source-dir "$PROJECT_ROOT/assets/source/animals/owl/cc_by_google_poly" \
	--output-root "$PROJECT_ROOT/assets/models_v2/animals"

"$BLENDER_BIN" --background --factory-startup --disable-autoexec --python-exit-code 1 --python "$PROJECT_ROOT/tools/blender/build_cinematic_moose.py" -- \
